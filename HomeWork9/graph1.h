...
namespace main_savitch_15
{
    ...
    public:
        ...
        double find_longest_helper(std::size_t source, std::size_t target) const;
        int find_longest(std::size_t source, std::size_t target) const;
...
#include "graph1.cpp" // Include the implementation.
#endif
